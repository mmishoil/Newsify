(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const c of e.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function n(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerPolicy&&(e.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?e.credentials="include":r.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function o(r){if(r.ep)return;r.ep=!0;const e=n(r);fetch(r.href,e)}})();const p=t=>{const s=localStorage.getItem("theme"),n=document.querySelector(t),o=document.documentElement;s==="dark"&&(o.setAttribute("data-theme","dark"),n.checked=!0),n.addEventListener("change",()=>{o.getAttribute("data-theme")==="dark"?(o.setAttribute("data-theme","light"),localStorage.setItem("theme","light")):(o.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"))})};let u=!1;const y=10,b=async(t,s,n=null,o=null,r=1)=>{if(r===1)u=!1;else if(u||r*y>100){console.log("All articles have been loaded.");return}let e="";const c=t.querySelector('[type="submit"]'),i=t.querySelector("#search-form-error"),m=new FormData(t),a=Object.fromEntries(m.entries());if(t.name==="searchTopHeadlinesForm"){e="/submit-form-headlines/";const l=a.q&&a.q.trim(),d=a.country&&a.country.trim();if(!l&&!d){i.textContent="Please enter a keyword or country.";return}}else if(t.name==="searchForm"){e="/submit-form/";const l=a.q&&a.q.trim(),d=a.date&&a.date.trim();if(!l&&!d){i.textContent="Please enter a keyword or date range.";return}if(d){const[h,f]=d.split(" to ");a.from=h,a.to=f??""}delete a.date}a.page=r,c.disabled=!0;try{const l=await s(a,e),{articles:d,terminate:h}=l;if(c.disabled=!1,u=h,!u){n&&l&&n(l);const f=document.querySelector(".card:last-child");setTimeout(()=>{o&&o(f)},100),i.textContent=""}}catch(l){console.error("Error:",l),c.disabled=!1,i.textContent="An error occurred. Please try again."}},v=t=>{let s=null;if(document.cookie&&document.cookie!==""){const n=document.cookie.split(";");for(let o=0;o<n.length;o++){const r=n[o].trim();if(r.substring(0,t.length+1)===t+"="){s=decodeURIComponent(r.substring(t.length+1));break}}}return s},w=async(t,s="GET",n=null)=>{const o={"X-Requested-With":"XMLHttpRequest","X-CSRFToken":v("csrftoken")},r={method:s,headers:o};n&&(r.body=JSON.stringify(n));const e=await fetch(t,r);if(!e.ok)throw new Error(`Error: ${e.statusText}`);return await e.json()},_=(t,s)=>w(s,"POST",t),k=t=>{const s=document.querySelector("#results"),n=s.querySelector(".gallery"),{articles:o,page:r}=t;if(r===1&&(n.innerHTML=""),o&&o.length>0){const e=s.querySelector(".section__title");e&&s.removeChild(e);const c=o.map(i=>`<div class="card">
        <div class="card__image">
          <img class="image" src="${i.urlToImage||"static/news/assets/images/img1.jpg"}" alt="${i.title}" />
        </div>
